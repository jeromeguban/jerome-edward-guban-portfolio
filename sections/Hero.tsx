...
const avatarTransitionFrames = [
  ...
  "/images/avatar-transition/8.png",
  "/images/avatar-transition/9.png",
  "/images/avatar-transition/10.png",
  "/images/avatar-transition/11.png",
  "/images/avatar-transition/12.png",
  "/images/avatar-transition/13.png",
  "/images/avatar-transition/14.png",
  "/images/avatar-transition/15.png",
  "/images/avatar-transition/16.png",
  "/images/avatar-transition/17.png",
  "/images/avatar-transition/18.png",
  "/images/avatar-transition/19.png",
  "/images/avatar-transition/20.png",
  "/images/avatar-transition/21.png",
  "/images/avatar-transition/22.png",
  "/images/avatar-transition/23.png",
  "/images/avatar-transition/24.png",
  "/images/avatar-transition/25.png",
  "/images/avatar-transition/26.png",
  "/images/avatar-transition/27.png",
  "/images/avatar-transition/28.png",
  "/images/avatar-transition/29.png",
  "/images/avatar-transition/30.png",
  "/images/avatar-transition/31.png",
  "/images/avatar-transition/32.png",
  "/images/avatar-transition/33.png",
  "/images/avatar-transition/34.png",
  "/images/avatar-transition/35.png",
  "/images/avatar-transition/36.png",
  "/images/avatar-transition/37.png",
  "/images/avatar-transition/38.png",
  "/images/avatar-transition/39.png",
  "/images/avatar-transition/40.png",
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const animateTyping = (currentIndex: number, isDeleting: boolean) => {
      if (!isDeleting) {
        if (currentIndex <= fullText.length) {
          setTypedText(fullText.slice(0, currentIndex));
          timeout = setTimeout(
            () => animateTyping(currentIndex + 1, false),
            100
          );
        } else {
          timeout = setTimeout(() => animateTyping(currentIndex, true), 2000);
        }
      } else {
        if (currentIndex >= 0) {
          setTypedText(fullText.slice(0, currentIndex));
          timeout = setTimeout(() => animateTyping(currentIndex - 1, true), 50);
        } else {
          timeout = setTimeout(() => animateTyping(0, false), 500);
        }
      }
    };

    animateTyping(0, false);
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute bottom-[35%] left-[8%] md:bottom-[40%] md:left-[15%] top-auto lg:top-[12%] lg:left-[60%] lg:bottom-auto z-5"
        animate={{
          y: [0, -15, 0],
          rotate: [0, 6, 0],
        }}
      ...
      {/* Node.js - Top Right of Avatar */}
      <motion.div
        className="absolute bottom-[35%] right-[44%] md:bottom-[45%] md:right-[15%] top-auto lg:top-[10%] lg:right-[8%] lg:bottom-auto z-5"
        animate={{
          y: [0, 15, 0],
          rotate: [0, -5, 0],
        }}
      ...
      {/* JavaScript - Left Side of Avatar */}
      <motion.div
        className="absolute bottom-[30%] left-[4%] md:bottom-[35%] md:left-[12%] top-auto lg:top-[30%] lg:left-[63%] lg:bottom-auto z-5"
        animate={{
          y: [0, 18, 0],
          rotate: [0, -7, 0],
        }}
      ...
      {/* PHP - Bottom Left of Avatar */}
      <motion.div
        className="absolute bottom-[18%] left-[6%] md:bottom-[22%] md:left-[15%] lg:top-[52%] lg:left-[55%] lg:bottom-auto z-5"
        animate={{
          y: [0, -18, 0],
          rotate: [0, 8, 0],
        }}
      ...
      {/* Laravel - Top Center Right */}
      <motion.div
        className="absolute bottom-[28%] right-[4%] md:bottom-[35%] md:right-[12%] top-auto lg:top-[18%] lg:right-[15%] lg:bottom-auto z-5"
        animate={{
          y: [0, -12, 0],
          rotate: [0, 4, 0],
        }}
      ...
      {/* MySQL - Bottom Left */}
      <motion.div
        className="absolute bottom-[8%] left-[12%] md:bottom-[10%] md:left-[20%] lg:bottom-[20%] lg:left-[60%] z-5"
        animate={{
          y: [0, 16, 0],
          rotate: [0, -6, 0],
        }}
      ...
      {/* Redis - Middle Right of Avatar */}
      <motion.div
        className="absolute bottom-[18%] right-[6%] md:bottom-[22%] md:right-[15%] top-auto lg:top-[40%] lg:right-[6%] lg:bottom-auto z-5"
        animate={{
          y: [0, 12, 0],
          rotate: [0, -8, 0],
        }}
      ...
      {/* Vue.js - Bottom Right of Avatar */}
      <motion.div
        className="absolute bottom-[8%] right-[12%] md:bottom-[10%] md:right-[20%] lg:bottom-[15%] lg:right-[10%] z-5"
        animate={{
          y: [0, -14, 0],
          rotate: [0, 5, 0],
        }}
      ...
      {/* Elastic - Far Right */}
      <motion.div
        className="absolute bottom-[35%] right-[8%] md:bottom-[40%] md:right-[15%] top-auto lg:top-[55%] lg:right-[4%] lg:left-auto lg:bottom-auto z-5"
        animate={{
          y: [0, 14, 0],
          rotate: [0, -7, 0],
        }}
          ...
          >
            <div className="theme-panel mt-2 flex w-full max-w-xl flex-col items-center rounded-3xl border p-6 text-center shadow-2xl backdrop-blur-xl md:mt-32 md:p-8 lg:mt-0 lg:max-w-xl lg:items-start lg:p-8 lg:text-left xl:max-w-2xl 2xl:max-w-3xl">
              ...
              <p className="theme-text-muted mb-8 max-w-xl text-lg leading-relaxed">
                ...
                databases, and scalable server-side systems. Focused on clean
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-10 justify-center lg:justify-start">
                <motion.button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
