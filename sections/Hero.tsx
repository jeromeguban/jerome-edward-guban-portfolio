  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden opacity-[0.04]">
        ...
        >
          SOFTWARE DEVELOPER • MID BACKEND DEVELOPER • SOFTWARE DEVELOPER • MID BACKEND DEVELOPER 
        </motion.div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden opacity-[0.03] top-64">
        ...
        >
          WEB DEVELOPER • UI/UX DESIGNER • SOFTWARE ENGINEER • WEB DEVELOPER • UI/UX DESIGNER • SOFTWARE ENGINEER • 
        </motion.div>
      </div>
            ...
            <div className="flex gap-4 pt-6 border-t border-white/10 justify-center md:justify-start">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="24" height="24">
                  <rect fill="#fff" x="4.83" y="4.83" width="118.35" height="118.35" rx="6.53" ry="6.53"/>
                  <path fill="#" d="M86.48 123.17V77.34h15.38l2.3-17.86H86.48v-11.4c0-5.17 1.44-8.7 8.85-8.7h9.46v-16A126.56 126.56 0 0091 22.7c-13.62 0-23 8.3-23 23.61v13.17H52.62v17.86H68v45.83z"/>
                </svg>
              </motion.a>
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              >
                <div className="relative">
                  ...
                  <div className="relative w-12 h-12 bg-white/10 backdrop-blur-sm rounded-2xl p-2 border border-white/20 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" className="w-full h-full">
                      <path fill="none" d="M0 8.934l49.854.158 14.167 24.47 14.432-24.47L128 8.935l-63.834 110.14zm126.98.637l-24.36.02-38.476 66.053L25.691 9.592.942 9.572l63.211 107.89zm-25.149-.008l-22.745.168-15.053 24.647L49.216 9.73l-22.794-.168 37.731 64.476zm-75.834-.17l23.002.009m-23.002-.01l23.002.01"/>
                      <path fill="#35495e" d="M25.997 9.393l23.002.009L64.035 34.36 79.018 9.404 102 9.398 64.15 75.053z"/>
                      <path fill="#41b883" d="M.91 9.569l25.067-.172 38.15 65.659L101.98 9.401l25.11.026-62.966 108.06z"/>
                    </svg>
                  </div>
                </div>
              </motion.div>
